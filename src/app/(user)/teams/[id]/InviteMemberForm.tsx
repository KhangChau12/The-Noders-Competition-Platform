      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="relative">
          ...
          <input
            ...
            required
            className="w-full pl-10 pr-4 py-2.5 bg-bg-surface border border-border-default rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue text-sm"
          />
        </div>
