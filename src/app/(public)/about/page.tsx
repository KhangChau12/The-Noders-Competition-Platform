  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-bg-surface rounded-full border border-border-default mb-4">
              <Code2 className="w-4 h-4 text-primary-blue" />
              <span className="text-sm font-semibold text-text-secondary">
                Powered by modern technologies
              </span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">Technology Stack</h2>
            <p className="text-lg text-text-secondary max-w-2xl mx-auto">
              Built with the latest technologies for best performance and user experience
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { name: 'Next.js 14', desc: 'Frontend', color: 'primary-blue' },
              { name: 'TypeScript', desc: 'Type Safety', color: 'accent-cyan' },
              { name: 'Supabase', desc: 'Backend', color: 'success' },
              ...
              >
                <div className="w-12 h-12 bg-primary-blue/10 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-primary-blue/20 transition-colors">
                  <Brain className="w-6 h-6 text-primary-blue" />
                </div>
                <div className="font-semibold text-text-primary mb-1 group-hover:text-primary-blue transition-colors">
                  {tech.name}
                </div>
      ...
      <section className="py-16 bg-bg-elevated/30">
        <div className="max-w-4xl mx-auto px-6">
          <Card className="relative overflow-hidden p-12 text-center border-primary-blue/30 bg-gradient-to-br from-primary-blue/5 via-accent-cyan/5 to-transparent">
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-brand" />

            <div className="relative z-10">
              <div className="w-16 h-16 bg-gradient-brand rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-primary-blue/50">
              ...
              <p className="text-lg text-text-secondary mb-8 max-w-2xl mx-auto leading-relaxed">
                Join our AI/ML community today. Explore competitions and improve your skills
              </p>
