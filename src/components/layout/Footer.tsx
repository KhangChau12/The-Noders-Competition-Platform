        ...
        <div className="grid md:grid-cols-2 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://twitter.com/thenoders" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-bg-surface border border-border-default hover:border-primary-blue hover:bg-primary-blue/10 flex items-center justify-center transition-all">
              ...
              <a href="https://github.com/thenoders" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-bg-surface border border-border-default hover:border-primary-blue hover:bg-primary-blue/10 flex items-center justify-center transition-all">
                <svg className="w-4 h-4 text-text-secondary" fill="currentColor" viewBox="0 0 24 24">
